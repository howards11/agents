...
agents = ['ucb_0_1', 'ucb_0_5', 'ucb_1', 'ucb_1_5',
        ...
        'arc_0_001', 'arc_0_01', 'arc_0_1', 'arc_1']
...
def per_arm_context_sampling_fn():
    ...
    return np.random.rand(GLOBAL_DIM + PER_ARM_DIM).astype(np.float32)/2
...
if use_previous_sims:
    previous_H = pickle.load( open('per_arm_with_var_2_data', "rb" ) )
...
pickle.dump(H, open('per_arm_with_var_2_data', "wb" ) )

################################ READ RESULTS ##################################

Data = pickle.load( open('per_arm_with_var_2_data', "rb" ) )
